...
// --- ПРО ПРОЄКТ (ABOUT) ---
   ...
   "art-body-ch2-quote": { 
    ...
    "contact-p1": { 
        "ru": "Открыт к предложениям, идеям, сотрудничеству и обратной связи. Если вы нашли ошибку на сайте, у вас есть вопросы по работе алгоритмов или предложения по улучшению проекта, напишите мне.", 
        "en": "Open to suggestions, ideas, collaboration, and feedback. If you find a bug on the site, have questions about how the algorithms work, or have suggestions for improving the project, please email me.", 
        "uk": "Відкритий до пропозицій, ідей, співпраці та зворотного зв'язку. Якщо ви знайшли помилку на сайті, у вас є питання щодо роботи алгоритмів або пропозиції щодо покращення проєкту, напишіть мені." 
    },
    "contact-tg": { 
        "ru": "Telegram:", 
        "en": "Telegram:", 
    ...
    "contact-p2": { 
        "ru": "Обычно я отвечаю в течение 24-48 часов.", 
        "en": "I usually reply within 24-48 hours.", 
        "uk": "Зазвичай я відповідаю протягом 24-48 годин." 
    },
    "footer-contact": { 
        "ru": "Контакты", 
        "en": "Contacts", 
